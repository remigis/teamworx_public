<template>
    <div>
        <DataTable v-model:value="gfItems" :filters.sync="filters" :page="page" :first.sync="first"
                   :paginator="true"
            ...
            <template #header>
                <div style="text-align: left">
                    ...
                    <Button label="Clear" icon="fa-solid fa-eraser" @click="clear"/>
                </div>
            </template>
