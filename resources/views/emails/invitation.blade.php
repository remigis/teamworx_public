                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                            ...
                                                            <h1 class="h3"
                                                                ...
                                                                align="left"><img
                                                                    src="https://www.boxinfo.lt/images/logo.png"
                                                                    style="height: 40px; width: auto; line-height: 100%; outline: none; text-decoration: none; display: block; border-style: none; border-width: 0;">
                                                            </h1>
                                                            ...
                                                            <h5 class="text-secondary"
                                                                ...
                                                                align="left">Invitation to join the Team</h5>
                                                            ...
                                                            <div class="space-y-3">
                                                                <p class="text-gray-700"
                                                                   ...
                                                                   align="left">Hello {{$name}} we are happy to invite
                                                                    you to join our team.</p>
                                                            </div>
                                                            <div class="space-y-3">
                                                                <p class="text-gray-700"
                                                                   style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;"
                                                                   align="left">Click "Join the team" button at the
                                                                    bottom of the page to finish registration.</p>
                                                            </div>
                                                            <table class="s-5 w-full" role="presentation" border="0"
                                                                   cellpadding="0" cellspacing="0" style="width: 100%;"
                                                                   width="100%">
                                                            ...
                                                            <table class="btn btn-primary" role="presentation"
                                                                ...
                                                                <tr>
                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;"
                                                                        ...
                                                                        <a href="{{Request::getSchemeAndHttpHost()}}/registerWithInvitation/{{$token}}"
                                                                           target="_blank"
                                                                           style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;">Join
                                                                            the team</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
